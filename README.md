...
En la siguiente imagen podemos ver la matriz de componentes, que recoge los valores asignados por el algoritmo a cada interés de los usuarios para cada segmento.
